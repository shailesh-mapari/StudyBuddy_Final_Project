        ...
        <div className={footerStyles.grid}>
            ...
            <div className={footerStyles.brandTransform}>
              <div className={footerStyles.brandContainer}>
                ...
                <div className="relative  font-serif flex items-center gap-3">
                  ...
                  <h3 className={footerStyles.brandTitle}>Studybuddy</h3>
                </div>
              </div>
          ...
          <div>
            <h4 className={`${footerStyles.sectionHeader} ${iconColors.cyan}`}>
              <ArrowRight className={footerStyles.socialIcon} />
              Quick Links
            </h4>
          ...
          <div>
            ...
            >
              <HandHelping className={footerStyles.socialIcon} />
              Supports
            </h4>
            <ul className={footerStyles.linksList}>
          ...
          <div>
            ...
            >
              <Phone className={footerStyles.socialIcon} />
              Contact Us
            </h4>

            ...
            {statsMeta.slice(0, 4).map((start, index) => (
              ...
              >
                <div className={aboutUsStyles.statNumber}>
                  {formatStatNumber(start.key)}
                </div>
                <div className={aboutUsStyles.statLabel}>{start.label}</div>
              </div>
            ))}
          </div>
        </div>
                ...
                <div className={aboutUsStyles.featuresContainer}>
                  {section.features.map((feature, featureIndex) => (
                    ...
                    >
                      ...
                      <span className={aboutUsStyles.featureItem}>
                        {feature}
                      </span>
                    </div>
                  ))}
      ...
      <section className={aboutUsStyles.ctaSection}>
        ...
        <div className={aboutUsStyles.ctaContent}>
          ...
          <p className={aboutUsStyles.ctaDescription}>
            Join millions of learners who have transfomed their lives with
            LearHub. Start your journey today with a 7-day free trail.
          </p>
